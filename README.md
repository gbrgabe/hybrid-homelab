...
| Device | IP | Role |
|---|---|---|
| OPNsense LAN | 10.0.0.1 | Gateway (OPNsense) |
| DC01 | 10.0.0.10 | Domain Controller |
| SRV-MON | 10.0.0.20 | Monitoring |
| SRV-APPS | 10.0.0.30 | Apps + AI Agents |
| PC01 | 10.0.0.101 | Windows 11 client |
| PC02 | 10.0.0.102 | Ubuntu Desktop client |
| PC03 | 10.0.0.103 | Ubuntu Desktop client |
| PC04 | 10.0.0.104 | Ubuntu Desktop client |
...
- [x] DC01 — Windows Server 2022 Core (AD DS, DNS, DHCP)
- [ ] SRV-MON — Zabbix + Grafana
